...
\begin{document}
	...
	\makeheading{Nghia Doan \hfill {\small Last update: October 5, 2021}}
	...
	%% =======================================
	\section{Education}
	\href{https://www.mcgill.ca/}{\textbf{McGill University}}, Montr\'eal, Queb\'ec, Canada \hfill 2017--2022 (expected)
	\begin{outerlist}
		\item Ph.D. in Electrical and Computer Engineering, GPA: {\bf 3.4/4.0}.
		\item Advisor: Professor \href{https://www.mcgill.ca/ece/warren-gross}{Warren Gross}. 
	\end{outerlist}
	...
	\begin{outerlist}
		...
		\item Advisor: Professor \href{http://capp.snu.ac.kr/}{Hyuk-Jae Lee}. 
	\end{outerlist}
	...
	\vspace{-0.25in}
	\begin{outerlist}
		\item \textbf{\textit{McGill Engineering Doctoral Award}} \hfill 2017
		\item \textbf{\textit{A-san Foundation Scholarship}} \hfill 2016
		\item \textbf{\textit{Samsung Electronics Award}} \hfill 2015
		\item \textbf{\textit{Scholarships for Academic Excellent}} \hfill 2009-2014		
	\end{outerlist}
	%% =======================================
	...
	\vspace{-0.25in}
	\begin{outerlist}
		\item {\it Programming Languages}: C/C++, Python, Assembly, VHDL.
		\item {\it Softwares and Libraries}: PyTorch, TensorFlow, MATLAB, OpenCV.
	\end{outerlist}
	%% =========  ==============================
	...
	\vspace{-0.25in}
	\begin{outerlist}
		\item {\bf High-Performance Decoding of Short Linear Block Codes with Machine Learning} \hfill 2017--present\\
		Utilizing state-of-the-art machine learning techniques in the design of high-performance decoding algorithms for short linear block codes, which are targeted for 5G-and-beyond communications standards.
	\end{outerlist}
	\begin{outerlist}
	...
	\end{outerlist}
	\begin{outerlist}
		\item {\bf Hardware-Friendly Encoding Algorithms of High-Efficiency Video Coding (HEVC)} \hfill 2015--2016\\
	...
	\begin{itemize}
		...
		\begin{enumerate}			
			\item \underline{N. Doan}, S. A. Hashemi, and W. J. Gross, "Efficient Soft-Input Soft-Output Decoding of CRC-Polar Concatenated Codes", IEEE Communications Letters, \textbf{{under preparation}}.
			
			\item \underline{N. Doan}, S. A. Hashemi, and W. J. Gross, "Decoding Reed-Muller Codes with Successive Factor-Graph Permutations", IEEE Transactions on Communications, \textbf{{submitted}}.
		...
		\begin{enumerate}
			...
			\item S. A. Hashemi, \underline{N. Doan}, and W. J. Gross, "Deep-Learning-Aided Successive-Cancellation Decoding of Polar Codes", Asilomar Conference on Signals, Systems, and Computers, Pacific Grove, USA, 2019.
			
			\item S. A. Hashemi, \underline{N. Doan}, M. Mondelli, and W. J. Gross, "Decoding Reed-Muller and Polar Codes by Successive Factor Graph Permutations", IEEE International Symposium on Turbo Codes \& Iterative Information Processing (ISTC), Hong Kong, China, 2018.
			...
			\item \underline{N. Doan}, T. S. Kim, H.-J. Lee, and S. I. Chae, "A modified TZ search algorithm for parallel integer motion estimation in high efficiency video coding", IEEE International SoC Design Conference (ISOCC), Gyeongju, South Korea, 2015.
		\end{enumerate}  
	\end{itemize} 
