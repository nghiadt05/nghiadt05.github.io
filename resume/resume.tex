...
\begin{document}
	...
	%% =======================================
	\section{Education}
	{\textbf{McGill University}}, Montr\'eal, Queb\'ec, Canada \hfill 2017--August 2022 (expected)
	\begin{outerlist}
	...
	\vspace{0.1in}
	{\textbf{Seoul National University}}, Seoul, South Korea \hfill 2015--2017
	\begin{outerlist}
	...
	\vspace{0.1in}
	{\textbf{Posts \& Telecommunications Institute of Technology}}, Hanoi, Vietnam \hfill 2009--2014
	\begin{outerlist}
	...
	\begin{outerlist}
		...
		Utilize state-of-the-art machine learning techniques in the design of low-complexity and high-performance decoding algorithms for short polar and Reed-Muller codes, which are targeted for 5G-and-beyond communications standards.
	\end{outerlist}
	\begin{outerlist}
